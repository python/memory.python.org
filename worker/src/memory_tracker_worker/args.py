...
def parse_args():
    ...
    list_binaries_parser = subparsers.add_parser(
        "list-binaries", help="List available registered binaries from server"
    )
    ...
    list_environments_parser = subparsers.add_parser(
        "list-environments", help="List available registered environments from server"
    )
    ...
    benchmark_parser = subparsers.add_parser(
        "benchmark", help="Run memory benchmarks on CPython commits"
    )
